          ...
          <div className="px-8 pb-8">
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-1 mb-3 relative overflow-hidden">
              ...
              <div className="mr-6 ml-1">
                ...
                <div className="flex items-baseline">
                  <p className="text-white text-xl font-medium">{Number(cashDividend).toFixed(2)}</p>
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-1 mb-3 relative overflow-hidden">
              ...
              <div className="mr-6 ml-1">
                ...
                <div className="flex items-baseline">
                  <p className="text-white text-xl font-medium">{Number(bonusDividend).toFixed(2)}</p>
                  <p className="text-yellow-500 text-lg ml-1">%</p>
                </div>
              </div>
            </div>
              ...
              <div className="relative">
                <div className="flex justify-between items-center">
                  <div className='ml-1'>
                    ...
                    <div className="flex items-baseline">
                      <p className="text-xl text-white font-medium">{totalDividend.toFixed(2)}</p>
                      <p className="text-yellow-500 text-lg ml-1">%</p>
                    </div>
                  </div>

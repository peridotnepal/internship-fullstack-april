export default function StockwiseDetailsTab() {
  return (
    <>
      {/* Date indicator */}
      ...
      <div className="mt-8 p-6 bg-black rounded-lg border border-white/20">
        <h2 className="text-xl font-bold mb-4">Stockwise Details</h2>
        <p className="text-white/70">Stockwise details will be displayed here.</p>
      </div>
    </>
  )
}

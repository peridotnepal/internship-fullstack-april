...
//     isLoserLoading,
// }) => {
//     const gainersData: ChartData<"polarArea"> = {
...
//     const losersData: ChartData<"polarArea"> = {
...
//                                 ? topGainers[context.dataIndex]?.percentageChange
//                                 : topLosers[context.dataIndex]?.percentageChange;
//                         return `${label}: ${
//                             originalValue !== undefined ? originalValue.toFixed(2) + "%" : value.toFixed(2) + "%"
//                         }`;
//                     },
//                 },
//             },
...
//                     const originalValue =
//                         datasetIndex === 0
//                             ? topGainers[dataIndex]?.percentageChange
//                             : topLosers[dataIndex]?.percentageChange;
...
//                     const arc = meta.data[dataIndex] as import('chart.js').ArcElement;
//                     const arcCircumference = arc?.circumference || 0;
//                     const arcRadius = arc?.outerRadius - arc?.innerRadius || 0;

//                     let fontSize = 14;
//                     if (arcCircumference < Math.PI / 6 || arcRadius < 20) fontSize = 10;
//                     else if (arcCircumference < Math.PI / 4) fontSize = 12;
//                     else if (arcCircumference < Math.PI / 3) fontSize = 14;
...
//                             <Skeleton className="bg-zinc-800 w-3/4 h-3/4 rounded-full" />
//                         </div>
//                     ) : topGainers.length === 5 ? (
//                         <div className="p-6 h-80 flex items-center justify-center">
//                             <PolarArea data={gainersData} options={chartOptions} />
//                         </div>
//                     ) : (
...
//                     ) : topLosers.length === 5 ? (
//                         <div className="p-6 h-80 flex items-center justify-center">
//                             <PolarArea data={losersData} options={chartOptions} />
//                         </div>
//                     ) : (
//                         <div className="flex items-center justify-center h-80 text-white/60">
//                             No data available

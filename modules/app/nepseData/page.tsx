...
const NepseData = () => {
  ...
  // Inside your NepseData component...
  const downloadScreenshot = () => {
    ...
    html2canvas(element, {
      scale: 2, // Increases quality (retina/high-res)
      useCORS: true, // Crucial if you have images from other domains
      backgroundColor: "#f9fafb", // Matches your bg-gray-50
    }).then((canvas) => {
      const image = canvas.toDataURL("image/png");
      const link = document.createElement("a");
      link.href = image;
      link.download = `NEPSE-Update-${new Date().toLocaleDateString()}.png`;
      link.click();
    });
  };
  ...
  if (!nepseData) {
    return (
      <div className="flex justify-center items-center h-screen">
        Wait few seconds ! data is loading...
      </div>
    );
  }
  return (
    <div>
      ...
      <div className="flex justify-end mt-10 mr-5 mb-5 cursor-pointer ">

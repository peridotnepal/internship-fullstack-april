...
export default function SectorPerformance() {
  ...
  return (
    <div id="export-sector" className="w-full p-6 space-y-6">
      {/* Header */}
      <div>
        <h2 className="text-2xl font-bold">Sector Performance</h2>
        <p className="text-gray-500">Daily sector-wise performance of NEPSE</p>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        {formattedData.map((sector) => (
          ...
          >
            <h3 className="text-sm text-gray-500">{sector.name}</h3>
      ...
      {/* Bar Chart */}
      <div className="w-full h-[400px] bg-white rounded-2xl shadow-sm border p-4">
        <h3 className="text-lg font-semibold mb-4">Sector Comparison (%)</h3>
